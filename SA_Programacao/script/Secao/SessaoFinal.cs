namespace SA_Programacao.script.Secao
{
    ...
    {
        public SecaoFinal(PersonagemProtagonista protagista) : base(protagista) { }
        public override void Iniciar()
        {
            ...
            if (protagonista.LeuLivro)
            {
                if (protagonista.Karma >= 20)
                {
                    ...
                    Texto.Mostrar("Hendriks se torna o novo representante e vira o aluno favorito,\n" +
                        "acaba por ficar com Kamilly e se torna oque ele sempre quis ser o \n" +
                        "Cara Mais importante da escola");
                    Texto.Mostrar("E bom lembramos que mesmo com as suas decisões\n" +
                ...
                Texto.Mostrar("Hendriks é visto como um monstro pela sala inteira\n" +
            ...
            Texto.Mostrar("As pessoas da escola mantém opiniões divididas sobre Hendriks,\n" +
